...
public final class FrameManager {
    ...
    public JsonLDWriteContext getDefaultContext(RDFFormat format, Model model, String id, Object frame) {
    ...
    public JsonLDWriteContext getDefaultContext(RDFFormat format, JsonLDWriteContext ctx, String id, Object frame) {
        ...
        if(format.equals(RDFFormat.JSONLD_FRAME_FLAT) || format.equals(RDFFormat.JSONLD_FRAME_PRETTY)) {
            if(frame==null) {
                Map<String, Object> idFrame = new HashMap<>();
                idFrame.put("@id", id);
    ...
    public String toJsonLDStringFromModel(Model model) {
        return toJsonLDStringFromModel(model, RDFFormat.JSONLD, null);
    }

    public String toJsonLDStringFromModel(Model model, RDFFormat format, JsonLDWriteContext ctx) {
    ...
    public Object toJsonLDObject(Model m, RDFFormat format) {
    ...
    public String modelToFramedString(Model model, String frame) {
    ...
    public Object toJsonLDObject(Model m, RDFFormat format, JsonLDWriteContext context) {
