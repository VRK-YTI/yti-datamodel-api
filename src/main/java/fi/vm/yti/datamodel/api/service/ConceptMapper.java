...
public class ConceptMapper {
    ...
    @Autowired
    ConceptMapper(EndpointServices endpointServices,
                  ApplicationProperties properties) {
        this.endpointServices = endpointServices;
        this.properties = properties;
    }
    
    public Response getFintoIDs() {
    ...
    public Model getModelFromFinto(String id) {

        Client client = ClientBuilder.newClient();
        WebTarget target = client.target(endpointServices.getVocabExportAPI(id))
    ...
    public void updateSchemesFromFinto() {

        Response resp = getFintoIDs();
        Model model = LDHelper.getJSONLDResponseAsJenaModel(resp);
        ...
        DatasetAccessor accessor = DatasetAccessorFactory.createHTTP(endpointServices.getTempConceptReadWriteAddress());

        while(idIter.hasNext()) {
            String fintoID = idIter.next().asLiteral().toString();
            if(!accessor.containsModel(properties.getDefaultScheme()+fintoID)) {
                logger.info("Loading "+fintoID+" from "+properties.getDefaultScheme());
                ...
                while(resIter.hasNext()) {
                    ...
                    schemeResource.addProperty(DCTerms.isFormatOf, ResourceFactory.createResource(properties.getDefaultScheme()+fintoID));

                    accessor.putModel(properties.getDefaultScheme()+fintoID, vocabModel);
                    ...
                    schemeModel.add(schemeResource, DCTerms.isFormatOf, ResourceFactory.createResource(properties.getDefaultScheme()+fintoID));
                }
     ...
     /*
      public void updateConceptFromConceptService(String uri) {
    ...
    */
    ...
    @Deprecated
    public void addConceptFromReferencedResource(String model, String classID) {
                /*
        String query
    ...
    @Deprecated
    public void removeUnusedConcepts(String model) {
        /*
        ParameterizedSparqlString pss = new ParameterizedSparqlString();
...
*/
    ...
    /*
    public void resolveConcept(String resource) {
...
*/
    @Deprecated
    public void addConceptToLocalSKOSCollection(String model, String concept) {
        /*
        String query
                = " INSERT { GRAPH ?skosCollection { ?skosCollection skos:member ?concept . }}"
    ...
    @Deprecated
    public boolean deleteModelReference(String model, String concept) {
            /*
    ...
    @Deprecated
    public void deleteConceptReference(String model, String concept) {
    ...
    @Deprecated
    public void deleteConceptSuggestion(String model, String concept) {
        /*
        DatasetGraphAccessorHTTP accessor = new DatasetGraphAccessorHTTP(services.getTempConceptReadWriteAddress());
        DatasetAdapter adapter = new DatasetAdapter(accessor);
    ...
    @Deprecated
    public void updateConceptSuggestion(String conceptID) {
