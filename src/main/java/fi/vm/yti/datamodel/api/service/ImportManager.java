...
public class ImportManager {
     ...
     */
    public void createResourceGraphs(String graph, Map<String, String> map) {
    ...
    private void updateResourceGraphs(String model, Map<String, String> map) {
    ...
    private void addIndexToProperty(String resource, String property, int index) {
    ...
    private void constructGraphs(String graph, String resource, Map<String, String> map) {
     ...
     */
    public void updateModelNamespaceInfo(String model, String namespace, String prefix) {
