...
public class GroupManager {
     ...
     */
     public static boolean compareDefaultGroups() {
         ...
         DatasetAccessor accessor = DatasetAccessorFactory.createHTTP(UserManager.services.getCoreReadWriteAddress());
    ...
    public static boolean testDefaultGroups() {
        ...
        pss.setNsPrefixes(LDHelper.PREFIX_MAP);
         ...
         QueryExecution qexec = QueryExecutionFactory.sparqlService(UserManager.services.getCoreSparqlAddress(), query);
