...
public class JerseyResponseManager {
    ...
    JerseyResponseManager(ModelManager modelManager, ApplicationProperties properties) {
    ...
    public Response ok(String content, String contentType) {
    ...
    public Response successUrnUuid(String uuid, String id) {
