...
public class ClassVisualizer {
    ...
    public Response visClass(
        ...
        queryString = "CONSTRUCT  { "
                ...
                +  "?property sh:minCount ?pmin . "
                +  "?property sh:maxCount ?pmax. "
                + "?classRef a ?type . "
                ...
                + "?propertyRef sh:minCount ?min . "
                + "?propertyRef sh:maxCount ?max . "
                + "} WHERE { "
                + "GRAPH ?classIRI { "
                + "?classIRI a ?classType . "
                ...
                +  "?property sh:maxCount ?pmax. "
                +  "}"
                +  "VALUES ?range { sh:valueShape sh:datatype } "
                +  "?property ?range ?classRef .  "
                +  "OPTIONAL { "
                ...
                +  "?propertyRef sh:predicate ?predicateRef . "
                +  "?propertyRef rdfs:label ?propertyRefLabel . "
                +  "VALUES ?refRange { sh:valueShape sh:datatype } "
                +  "?propertyRef ?refRange ?propertyRefRange . "
                + "OPTIONAL {"
                + "?propertyRef sh:minCount ?min . "
                + "}"
