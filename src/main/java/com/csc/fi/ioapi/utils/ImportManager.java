...
public class ImportManager {
    ...
    public static void createResourceGraphs(String graph, Map<String, String> map) {
        ...
        String query
                ...
                + "WHERE { "
                + " GRAPH ?graph { "
                + " VALUES ?type { sh:ShapeClass sh:Shape owl:DatatypeProperty owl:ObjectProperty } "
                + " ?resource a ?type . "
                + " OPTIONAL { "
                + "  ?resource dcterms:subject ?subject . "
                + "  ?subject ?sp ?so . "
    ...
    public static void removeDuplicatesFromModel(String graph) {
        ...
        String query
                ...
                + "GRAPH ?graph { "
                + "?graph owl:imports ?import .  "
                + "OPTIONAL { VALUES ?type { sh:ShapeClass sh:Shape owl:DatatypeProperty owl:ObjectProperty } "
                + "?resource a ?type . "
                + "?resource ?p ?o . "
