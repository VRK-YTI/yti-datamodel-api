...
public class ProfileData {
  ...
  @Produces("application/ld+json")
  public Response frameJson(@ApiParam(value = "Context in application/ld+json", required = true) String inputContext, @ApiParam(value = "Requested graph", required = true) @QueryParam("graph") String graph) {
    ...
    try {
        ...
        try {
           ...
           // Object compact = JsonLdProcessor.compact(data, context, options); 
            ...
            Logger.getLogger(ProfileData.class.getName()).log(Level.WARNING, "Error in reading JSON-LD", ex);
