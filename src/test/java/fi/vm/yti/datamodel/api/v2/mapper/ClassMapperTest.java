...
class ClassMapperTest {
    ...
    void testCreateClassAndMapToModelLibrary() {
        ...
        dto.setEquivalentClass(Set.of(Constants.DATA_MODEL_NAMESPACE + "int/EqClass"));
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "int/EqClass", classResource.getProperty(OWL.equivalentClass).getObject().toString());
    ...
    void testMapToClassDTOLibrary(){
        ...
        assertEquals(new UriDTO(Constants.DATA_MODEL_NAMESPACE + "test/EqClass"), dto.getEquivalentClass().stream().findFirst().orElse(null));
        assertEquals(1, dto.getSubClassOf().size());
        assertEquals(new UriDTO(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/SubClass", "test:SubClass"),
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestClass", dto.getUri());
    }
    ...
    void testMapToUpdateClassLibrary(){
        ...
        dto.setEquivalentClass(Set.of(Constants.DATA_MODEL_NAMESPACE + "int/NewEq"));
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/EqClass", resource.listProperties(OWL.equivalentClass)
                .filterDrop(p -> p.getObject().isAnon())
                .next().getObject().toString());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/SubClass", resource.getProperty(RDFS.subClassOf).getObject().toString());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "int/NewEq", resource.listProperties(OWL.equivalentClass)
                .filterDrop(p -> p.getObject().isAnon())
                .next().getObject().toString());
    ...
    void testMapReferenceResourceAndAddNamespace() {
        ...
        dto.setSubClassOf(Set.of(
                Constants.DATA_MODEL_NAMESPACE + "ns-int-1/sub",
                uri.getModelURI() + "test-sub"
        ));
        dto.setEquivalentClass(Set.of(Constants.DATA_MODEL_NAMESPACE + "ns-int-1/eq"));
        dto.setDisjointWith(Set.of(Constants.DATA_MODEL_NAMESPACE + "ns-int-2/disjoint"));
        ...
        assertTrue(imports.containsAll(Set.of(
                Constants.DATA_MODEL_NAMESPACE + "ns-int-1/",
                Constants.DATA_MODEL_NAMESPACE + "ns-int-2/"
                ))
        );
    }
    ...
    void testMapTerminologyToModel() {
        ...
        assertTrue(requires.contains(Constants.TERMINOLOGY_NAMESPACE + "test-terminology"));
    }
