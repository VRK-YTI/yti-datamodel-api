...
class ResourceMapperTest {
    ...
    void mapToResourceAssociation() {
        ...
        dto.setEquivalentResource(Set.of(Constants.DATA_MODEL_NAMESPACE + "int/EqRes"));
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/Resource", modelResource.getProperty(DCTerms.hasPart).getObject().toString());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "int/EqRes", resourceResource.getProperty(OWL.equivalentProperty).getObject().toString());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/RangeClass", MapperUtils.propertyToString(resourceResource, RDFS.range));
    ...
    void testMapToIndexResourceClass(){
        ...
        var indexClass = ResourceMapper.mapToIndexResource(m, Constants.DATA_MODEL_NAMESPACE + "test/TestClass");

        assertEquals(ResourceType.CLASS, indexClass.getResourceType());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestClass", indexClass.getId());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/", indexClass.getIsDefinedBy());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/", indexClass.getNamespace());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/", indexClass.getVersionIri());
    }
    ...
    void testMapToIndexResourceAttribute(){
        ...
        var indexClass = ResourceMapper.mapToIndexResource(m, Constants.DATA_MODEL_NAMESPACE + "test/TestAttribute");

        assertEquals(ResourceType.ATTRIBUTE, indexClass.getResourceType());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestAttribute", indexClass.getId());
        assertEquals("test note fi", indexClass.getNote().get("fi"));
        assertEquals(Status.VALID, indexClass.getStatus());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/DomainClass", indexClass.getDomain());
    ...
    void testMapToIndexResourceAssociation(){
        ...
        var indexClass = ResourceMapper.mapToIndexResource(m, Constants.DATA_MODEL_NAMESPACE + "test/TestAssociation");

        assertEquals(ResourceType.ASSOCIATION, indexClass.getResourceType());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestAssociation", indexClass.getId());
        assertEquals("test note fi", indexClass.getNote().get("fi"));
        assertEquals(Status.VALID, indexClass.getStatus());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/DomainClass", indexClass.getDomain());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/RangeClass", indexClass.getRange());
        assertEquals("1.0.1", indexClass.getFromVersion());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/", indexClass.getVersionIri());
    }
    ...
    void testMapToIndexResourceMinimalAttribute(){
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/TestAttribute", indexResource.getId());
    ...
    void mapToResourceInfoDTOAttribute() {
        ...
        assertEquals(new UriDTO(Constants.DATA_MODEL_NAMESPACE + "test/SubResource"), dto.getSubResourceOf().stream().findFirst().orElse(null));
        assertEquals(1, dto.getEquivalentResource().size());
        assertEquals(new UriDTO(Constants.DATA_MODEL_NAMESPACE + "test/EqResource"), dto.getEquivalentResource().stream().findFirst().orElse(null));
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestAttribute", dto.getUri());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/DomainClass", dto.getDomain().getUri());
    ...
    void mapToResourceInfoDTOAssociation() {
        ...
        assertEquals("Yhteentoimivuusalustan yllapito", dto.getContributor().stream().findFirst().orElseThrow().getLabel().get("fi"));
        assertEquals(MapperTestUtils.TEST_ORG_ID.toString(), dto.getContributor().stream().findFirst().orElseThrow().getId());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/TestAssociation", dto.getUri());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/DomainClass", dto.getDomain().getUri());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/1.0.1/RangeClass", dto.getRange().getUri());
    ...
    void mapToResourceInfoDTOAttributeMinimal() {
        ...
        assertEquals("Yhteentoimivuusalustan yllapito", dto.getContributor().stream().findFirst().orElseThrow().getLabel().get("fi"));
        assertEquals(MapperTestUtils.TEST_ORG_ID.toString(), dto.getContributor().stream().findFirst().orElseThrow().getId());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/TestAttribute", dto.getUri());
    }
    ...
    void mapToResourceInfoDTOAssociationMinimal() {
        ...
        assertEquals("Yhteentoimivuusalustan yllapito", dto.getContributor().stream().findFirst().orElseThrow().getLabel().get("fi"));
        assertEquals(MapperTestUtils.TEST_ORG_ID.toString(), dto.getContributor().stream().findFirst().orElseThrow().getId());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/TestAssociation", dto.getUri());
    }
    ...
    void mapToResourceInfoAuthenticatedUser() {
        ...
        Consumer<ResourceCommonInfoDTO> userMapper = (var dto) -> {
    ...
    void mapToUpdateModelAttribute() {
        ...
        dto.setEquivalentResource(Set.of(Constants.DATA_MODEL_NAMESPACE + "int/NewEq"));
        ...
        dto.setDomain(Constants.DATA_MODEL_NAMESPACE + "test/NewDomainClass");
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/EqResource", resource.getProperty(OWL.equivalentProperty).getObject().toString());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/SubResource", resource.getProperty(RDFS.subPropertyOf).getObject().toString());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/DomainClass", MapperUtils.propertyToString(resource, RDFS.domain));
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "int/NewEq", resource.getProperty(OWL.equivalentProperty).getObject().toString());
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/NewDomainClass", MapperUtils.propertyToString(resource, RDFS.domain));
    ...
    void mapToUpdateModelAssociation() {
        ...
        dto.setEditorialNote("new editorial note");
        dto.setDomain(Constants.DATA_MODEL_NAMESPACE + "test/NewDomainClass");
        dto.setRange(Constants.DATA_MODEL_NAMESPACE + "test/NewRangeClass");
        dto.setFunctionalProperty(true);
        dto.setTransitiveProperty(true);
        dto.setReflexiveProperty(true);
        ...
        assertEquals(2, resource.listProperties(RDFS.comment).toList().size());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/DomainClass", MapperUtils.propertyToString(resource, RDFS.domain));
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/RangeClass", MapperUtils.propertyToString(resource, RDFS.range));
        assertTrue(MapperUtils.hasType(resource, OWL.FunctionalProperty));
        ...
        assertEquals("fi", resource.getProperty(RDFS.comment).getLiteral().getLanguage());
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/NewDomainClass", MapperUtils.propertyToString(resource, RDFS.domain));
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "test/NewRangeClass", MapperUtils.propertyToString(resource, RDFS.range));
        assertTrue(MapperUtils.hasType(resource, OWL.FunctionalProperty));
    ...
    void mapToUpdateAttributeEmptySubResource(){
        ...
        resource = m.getResource(Constants.DATA_MODEL_NAMESPACE + "test/TestAttribute");
    ...
    void mapToUpdateAssociationEmptySubResource(){
        ...
        m = MapperTestUtils.getModelFromFile("/models/test_datamodel_library_with_resources.ttl");
        resource = m.getResource(Constants.DATA_MODEL_NAMESPACE + "test/TestAssociation");
    ...
    void mapIndexResourceInfo() {
        ...
        assertEquals(GraphType.LIBRARY, dataModel.getModelType());
    ...
    void testUpdateRestrictionsAfterRangeChange() {
        ...
        var updated = list.asJavaList().stream()
                .filter(r -> r.asResource().getProperty(OWL.onProperty).getObject().toString()
                        .equals(Constants.DATA_MODEL_NAMESPACE + "model/attribute-1"))
                .findFirst();
    ...
    void testMapReferenceResourceAndAddNamespace() {
        ...
        attrDTO.setSubResourceOf(Set.of(Constants.DATA_MODEL_NAMESPACE + "ns-int-1/sub"));
        attrDTO.setEquivalentResource(Set.of(Constants.DATA_MODEL_NAMESPACE + "ns-int-2/eq"));
    ...
    void testMapReferencePropertyShapeAndAddNamespace() {
        ...
        propertyShape.setPath(Constants.DATA_MODEL_NAMESPACE + "/test_lib_2/path");
        propertyShape.setClassType(Constants.DATA_MODEL_NAMESPACE + "test_lib_2/class");
