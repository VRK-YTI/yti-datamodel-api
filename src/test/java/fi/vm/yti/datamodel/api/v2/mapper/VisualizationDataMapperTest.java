...
class VisualizationDataMapperTest {
    ...
    private final Map<String, String> libraryNamespaces = Map.of(
            Constants.DATA_MODEL_NAMESPACE + "yti-model/", "yti-model",
            "https://www.example.com/ns/external/", "ext");

    private final Map<String, String> profileNamespaces = Map.of(
            Constants.DATA_MODEL_NAMESPACE + "personprof/", "personprof",
            Constants.DATA_MODEL_NAMESPACE + "ytm/", "ytm"
    );
    ...
    void mapLibraryAttributesAndAssociations() {
        var model = MapperTestUtils.getModelFromFile("/models/test_datamodel_library_visualization.ttl");
        var classResource = model.getResource(Constants.DATA_MODEL_NAMESPACE + "visu" + Constants.RESOURCE_SEPARATOR + "person");
    ...
    void mapAssociationsWithDomain() {
        var model = MapperTestUtils.getModelFromFile("/models/test_datamodel_library_visualization.ttl");
        var classResource = model.getResource(Constants.DATA_MODEL_NAMESPACE + "visu" + Constants.RESOURCE_SEPARATOR + "address");
        var classDTO = new VisualizationClassDTO();
    ...
    void mapLibraryClassWithExternalResources() {
        var model = MapperTestUtils.getModelFromFile("/models/test_datamodel_library_visualization.ttl");
        var classURI = Constants.DATA_MODEL_NAMESPACE + "visu" + Constants.RESOURCE_SEPARATOR + "person";
        var externalResources = new HashSet<Resource>();
    ...
    void mapApplicationProfileClass() {
        ...
        assertEquals(Constants.DATA_MODEL_NAMESPACE + "personprof/ext-attr", externalResources.iterator().next().getURI());
    ...
    void mapPositionDataToGraph() {
        var positionGraphURI = ModelConstants.MODEL_POSITIONS_NAMESPACE + "test-model" + Constants.RESOURCE_SEPARATOR;
    ...
    void mapPositionDataWithParentClasses() {
        ...
        var positionGraphURI = ModelConstants.MODEL_POSITIONS_NAMESPACE + modelPrefix + Constants.RESOURCE_SEPARATOR;
